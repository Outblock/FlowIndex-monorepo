...
const TYPE_TAG_CLASSES: Record<string, string> = {
  ...
  stake: 'bg-violet-100 text-violet-700 dark:bg-violet-500/20 dark:text-violet-400',
  staking: 'bg-violet-100 text-violet-700 dark:bg-violet-500/20 dark:text-violet-400',
