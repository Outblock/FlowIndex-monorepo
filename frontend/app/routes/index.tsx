            ...
            <div className="border-b border-zinc-200 dark:border-white/5 bg-white/50 dark:bg-nothing-dark/50">
                <div className="container mx-auto px-4 py-12 space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        >
                            <NetworkStats totalStaked={networkStats?.total_staked} totalSupply={networkStats?.total_supply} activeNodes={networkStats?.active_nodes} stakingApy={networkStats?.staking_apy} />
                        </motion.div>
                    </div>
                </div>
            </div>
