...
import {
  ...
  flowTransferFlowTool,
  flowTransferFtTool,
  flowTransferNftTool,
  flowStakeTool,
  flowUnstakeTool,
  flowWithdrawRewardsTool,
  flowEvmCallTool,
  flowEvmSendTool,
  flowCreateAccountTool,
  flowAddKeyTool,
  flowRemoveKeyTool,
  flowBatchTransferTool,
  flowMultiSignTool,
  flowFormatAddressTool,
  flowDecodeEventTool,
  flowEncodeArgumentsTool,
  flowNftCatalogLookupTool,
  flowTokenListLookupTool,
  flowIncrementFiTool,
...
export const tools: Record<string, ToolConfig> = {
  ...
  flow_transfer_flow: flowTransferFlowTool,
  flow_transfer_ft: flowTransferFtTool,
  flow_transfer_nft: flowTransferNftTool,
  flow_stake: flowStakeTool,
  flow_unstake: flowUnstakeTool,
  flow_withdraw_rewards: flowWithdrawRewardsTool,
  flow_evm_call: flowEvmCallTool,
  flow_evm_send: flowEvmSendTool,
  flow_create_account: flowCreateAccountTool,
  flow_add_key: flowAddKeyTool,
  flow_remove_key: flowRemoveKeyTool,
  flow_batch_transfer: flowBatchTransferTool,
  flow_multi_sign: flowMultiSignTool,
  flow_format_address: flowFormatAddressTool,
  flow_decode_event: flowDecodeEventTool,
  flow_encode_arguments: flowEncodeArgumentsTool,
  flow_nft_catalog_lookup: flowNftCatalogLookupTool,
  flow_token_list_lookup: flowTokenListLookupTool,
